...
import Modal from "../../components/Modal_name_enth_fedtax_id"; // เเก้ modal ด้วย
...
import {
  ...
  update,
  deleteById,
} from "../../services/legalorganization"; // เเก้ service ด้วย
import UpdateButton from "../../components/buttons/UpdateButton";
import DeleteButton from "../../components/buttons/DeleteButton";
import AddButton from "../../components/buttons/AddButton";

export default function LegalOrganization() {
  ...
  return (
    <>
      <AppBarCustom title="Legal Organization องค์กรจดทะเบียน" />
      {loading ? (
