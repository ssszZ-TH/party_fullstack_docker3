...
import Modal from "../../components/modal/GovernmentAgencyModal";
import Loading from "../../components/Loading";
import { create, get, list, update, deleteById } from "../../services/governmentAgency";
import UpdateButton from "../../components/buttons/UpdateButton";
import DeleteButton from "../../components/buttons/DeleteButton";
import AddButton from "../../components/buttons/AddButton";

export default function GovernmentAgency() {
  ...
  return (
    <>
      <AppBarCustom title="Government Agency หน่วยงานราชการ" />
      {loading ? (
        <Loading />
      ) : (
        <DataTable
